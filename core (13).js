...
function refreshTitleScreen(){
  ...
  // XI button state — unlocks at 11 discovered (via fl_xi_unlocked flag set by checkXIUnlock)
  ...
  if(xiBtn){
    ...
    if(xiUnlocked){
      ...
      // Pre-unlock teaser — shows progress toward 11
      xiBtn.style.display = 'block';
      xiBtn.style.borderColor = '#444';
      xiBtn.style.color = '#666';
      xiBtn.disabled = true;
      xiBtn.textContent = count + ' / 11 — UNLOCK XI';
      xiBtn.onclick = null;
    } else {
