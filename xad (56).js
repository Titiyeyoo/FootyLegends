...
function xadShareXI(){
  ...
  ctx.fillText(((S.emoji?S.emoji+" ":"")+S.title), W/2, 240);
  // boisko
  const pW=520, pH=Math.round(pW*4/3), pX=(W-pW)/2, pY=260;
  ...
  (S.slots||[]).forEach(function(s){
    ...
    ctx.save(); ctx.shadowColor=col; ctx.shadowBlur=16;     // glow jak w grze
