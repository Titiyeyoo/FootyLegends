...
window.flRadarData = function(){
  ...
  return {games:g, formGames:rg, tier:tier, life:life, form:form,
...
window.openLegend = function(){
  ...
  var facts=flRow("FAVOURITE ERA", d.games<5?"Too early":d.favEra)
          + flRow("MOST PICKED", d.games<5?"Too early":d.mostPicked)
          + flRow("STORIES FOUND", d.storiesFound)
          + flRow("RAREST FIND", rar);
  b.innerHTML=
    ...
    '<div class="legend-soon">'+gate+'</div>'+
    '<div style="margin-top:14px;font-size:10px;color:#6b6857;letter-spacing:1px;border:1px dashed #33312a;border-radius:6px;padding:11px 16px;display:inline-block">SHARE unlocks when your fan type is revealed</div>';
  go("s-legend");
};
