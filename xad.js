...
window.FLCard = (function(){
  ...
  function drawRarityFooter(ctx,o){
    ...
    ctx.textAlign="center";
    if(ctx.letterSpacing!==undefined) ctx.letterSpacing="3px";
    ctx.fillStyle=col; ctx.font="bold 27px Arial, sans-serif"; ctx.fillText(lbl, W/2, H-250);
    ctx.fillStyle="#6f7d71"; ctx.font="bold 21px Arial, sans-serif"; ctx.fillText(found+" / "+tot+" DISCOVERED", W/2, H-222);
    if(ctx.letterSpacing!==undefined) ctx.letterSpacing="0px";
    ctx.textAlign="center";
  }
