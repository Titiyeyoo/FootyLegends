...
function flObservations(pr){
  ...
  try{
    ...
    var rA=_obsRecent(pr, IDX.attack, 5);
    if(rA && rA.pct>=60) out.push({id:"hab_atk", cat:"HABIT", w:32+rA.pct,
      text:"Your XI leans forward.", proof:"Attack-heavy in "+rA.pct+"% of recent lineups."});
    var rDf=_obsRecent(pr, IDX.defense, 5);
    if(rDf && rDf.pct>=60) out.push({id:"hab_def", cat:"HABIT", w:32+rDf.pct,
      text:"You build from the back.", proof:"Defence-heavy in "+rDf.pct+"% of recent lineups."});
    // formacja
    ...
    if(distinct>=100) out.push({id:"first_100leg", cat:"FIRST", w:190, text:"A hundred different legends have worn your shirt.", proof:distinct+" and counting."});
