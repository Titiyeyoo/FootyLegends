...
/* Etap 4 — popup odkrycia (kolekcjonerski); rarity = realne % z symulacji */
const STORY_INFO = {
  heroes66:{e:"🏆",n:"1966 HEROES",pct:"fewer than 1% of squads find this"},
  italia90:{e:"😢",n:"ITALIA 90",pct:"fewer than 1% of squads find this"},
  euro96:{e:"🎤",n:"EURO 96",pct:"~8% of squads find this story"},
  golden:{e:"⭐",n:"GOLDEN GENERATION",pct:"~9% of squads find this story"},
  southgate:{e:"🦁",n:"SOUTHGATE ERA",pct:"~8% of squads find this story"},
  class92:{e:"🔴",n:"CLASS OF 92",pct:"~7% of squads find this story"},
  forest:{e:"⚫",n:"FOREST EUROPEAN KINGS",pct:"fewer than 1% of squads find this"},
  blackburn:{e:"🔵",n:"BLACKBURN 95",pct:"~7% of squads find this story"},
  newcastle:{e:"⚪",n:"NEWCASTLE ENTERTAINERS",pct:"~8% of squads find this story"},
  foxes:{e:"🦊",n:"FOXES 2016",pct:"~9% of squads find this story"},
  liverpool:{e:"🔴",n:"LIVERPOOL DYNASTY",pct:"~3% of squads find this story"},
  eagles:{e:"🦅",n:"EAGLES RISING",pct:"~10% of squads find this story"},
  citydynasty:{e:"💙",n:"CITY DYNASTY",pct:"~8% of squads find this story"},
  crazygang:{e:"⚡",n:"CRAZY GANG ENERGY",pct:"~1% of squads find this story"},
  arch_club:{e:"🛡️",n:"CLUB TRIBUTE",pct:"~2% of squads find this story"},
  arch_era:{e:"⏳",n:"SAME ERA XI",pct:"~9% of squads find this story"},
  arch_underdog:{e:"🐶",n:"UNDERDOG XI",pct:"fewer than 1% of squads find this"},
};
function showStoryDiscovery(key){
  ...
  ov.innerHTML =
    '<div class="xsp-card">'+
      ...
      '<div class="xsp-rar">'+info.pct+'</div>'+
    '</div>';
  ov.className = "show";
...
function lockXI(){
  ...
  html += '</div>';
  // Etap 5 — licznik postępu na revealu (zawsze; BEZ totalu — total ujawnia dopiero Legacy)
  html += '<div class="xad-legacy-progress"><div class="xlp-lbl">LEGACY PROGRESS</div>'+
