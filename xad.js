...
window.openLegend = function(){
  ...
  b.innerHTML=
    ...
    '<div class="legend-title"><span onclick="try{changeName()}catch(e){}" style="cursor:pointer;border-bottom:2px dotted #7a7660">'+flLegendOwner()+'</span> FOOTY LEGEND <span onclick="try{changeName()}catch(e){}" style="cursor:pointer;color:#e9c46a;font-size:11px;margin-left:2px">\u270E</span></div>'+
