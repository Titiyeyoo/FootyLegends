...
const NARRATIVES = {
  ...
  goalscorers:{name:"GOALSCORERS",desc:"The deadliest finishers English football has produced.",emoji:"⚽",cat:"theme",iconic:2,players:["Jimmy Greaves","Alan Shearer","Harry Kane","Wayne Rooney","Steve Bull","Jermain Defoe","Roger Hunt","Frank Lampard","Bobby Charlton","Martin Peters","Raich Carter","John Barnes","Steven Gerrard","Peter Beardsley","Alan Ball","Raheem Sterling","David Platt","Matthew Le Tissier","Johnny Haynes","Paul Scholes","Stuart Pearce","Steve Bruce","Jack Charlton","Phil Neal","John Terry","Julian Dicks","Steve Walsh","Chris Lawler","Tommy Smith","Tony Adams","Emlyn Hughes"]},
};
...
const STORY_INFO = {
  ...
  goalscorers:{e:"⚽",n:"GOALSCORERS",tier:"common"},
};
