...
window.openLegend = function(silent){
  ...
  b.innerHTML=
    ...
    '<div id="legend-clean-btn" data-clean-hide onclick="flCleanView()" style="position:fixed;top:14px;right:14px;z-index:50;width:34px;height:34px;border:1px solid #6a6656;border-radius:6px;display:flex;align-items:center;justify-content:center;cursor:pointer;background:rgba(0,0,0,0.45)"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#e9c46a" stroke-width="2" stroke-linejoin="round"><path d="M4 8h3l2-2h6l2 2h3v11H4z"/><circle cx="12" cy="13" r="3.2"/></svg></div>'+
