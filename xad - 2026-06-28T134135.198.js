...
function flFanType(pr){
  ...
  var ax=flAxisVals(pr.pickSum,pr.availSum,pr.games,11,30);
  var cand=[["vintage",ax.C],["modern",ax.M],["golden",ax.G],["stars",ax.stars],["scout",ax.deep],["attack",ax.attack],["backbone",ax.defense]];
  cand.sort(function(a,b){return b[1]-a[1];});
  return cand[0][1] < 8 ? "balanced" : cand[0][0];
}
...
window.openLegend = function(){
  ...
  b.innerHTML=
    '<button class="legend-back" onclick="go(\'s-title\')">&lsaquo; BACK</button>'+
