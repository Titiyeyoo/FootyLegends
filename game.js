...
function resetHOF(){
  if(!confirm("Reset everything? Scores, discovered legends, streak and unlocks will all be wiped. This can't be undone.")) return;
  ...
  // odśwież ekran ustawień (streak, licznik legend 0/833, tier) jeśli widoczny
