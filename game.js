...
function openLegacy(){
  ...
  const _foundCard = s => '<div class="lg-card found r-'+s.r.toLowerCase()+'"><div class="lg-emoji">'+(s.k==="class92"?XAD_DEVIL_SVG:s.e)+'</div><div class="lg-name">'+s.n+'</div><div class="lg-rar">'+s.r+'</div></div>';
  ...
  body.innerHTML =
    ...
    '<button class="btn btn-dim" style="margin-top:12px" onclick="openModal()">👁 VIEW ALL MY LEGENDS</button>'+
    '<button class="btn btn-dim" style="margin-top:6px" onclick="go(\'s-hof\')">🏆 VIEW ALL SCORES</button>';
  go('s-legacy');
}
