...
const XAD_STORIES = [
  {k:"heroes66",e:"🏆",n:"1966 HEROES",r:"LEGENDARY"},
  {k:"italia90",e:"😢",n:"ITALIA 90",r:"LEGENDARY"},
  {k:"euro96",e:"🎤",n:"EURO 96",r:"RARE"},
  {k:"golden",e:"⭐",n:"GOLDEN GENERATION",r:"COMMON"},
  {k:"southgate",e:"🦁",n:"SOUTHGATE ERA",r:"RARE"},
  {k:"class92",e:"😈",n:"CLASS OF 92",r:"RARE"},
  {k:"forest",e:"⚫",n:"FOREST EUROPEAN KINGS",r:"LEGENDARY"},
  {k:"blackburn",e:"🔵",n:"BLACKBURN 95",r:"RARE"},
  {k:"newcastle",e:"⚪",n:"NEWCASTLE ENTERTAINERS",r:"RARE"},
  {k:"foxes",e:"🦊",n:"FOXES 2016",r:"COMMON"},
  {k:"liverpool",e:"🔴",n:"LIVERPOOL DYNASTY",r:"EPIC"},
  {k:"eagles",e:"🦅",n:"EAGLES RISING",r:"COMMON"},
  {k:"citydynasty",e:"💙",n:"CITY DYNASTY",r:"RARE"},
  {k:"crazygang",e:"⚡",n:"CRAZY GANG ENERGY",r:"EPIC"},
  {k:"bornleaders",e:"🎖️",n:"BORN LEADERS",r:"EPIC"},
  {k:"nearlymen",e:"🥈",n:"THE NEARLY MEN",r:"EPIC"},
  {k:"arch_club",e:"🛡️",n:"CLUB TRIBUTE",r:"EPIC"},
  {k:"arch_era",e:"⏳",n:"SAME ERA XI",r:"RARE"},
  {k:"arch_underdog",e:"🐶",n:"UNDERDOG XI",r:"LEGENDARY"},
];
...
function xadShowSquad(key){
  ...
  var story=XAD_STORIES.filter(function(s){return s.k===key;})[0];
...
function openLegacy(){
  ...
  const found = XAD_STORIES.filter(s => disc.has(s.k)).length;
  const total = XAD_STORIES.length;
  ...
  const _discovered = XAD_STORIES.filter(s => disc.has(s.k)).sort((a,b)=> _rank[a.r.toLowerCase()] - _rank[b.r.toLowerCase()]);
  const _locked = XAD_STORIES.filter(s => !disc.has(s.k));
  ...
  if(!body) return;
  body.innerHTML =
    '<div class="lg-sec xad"><span class="lg-ic">🃏</span> XI AFTER DARK</div>'+
    '<div class="lg-count">STORIES DISCOVERED <b>'+found+' / '+total+'</b></div>'+
...
function updateCollectionStats(){
  ...
  const xadTotal = (typeof XAD_STORIES !== "undefined" && XAD_STORIES.length) ? XAD_STORIES.length : 17;
