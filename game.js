...
function _obsHTML(){
  ...
  if(!list.length){
    return '<div class="lg-hint" style="padding:6px 0 2px;line-height:1.7">the game is starting to notice how you play…<br>your first observations will appear here.</div>';
  }
...
window.toggleObs = function(){ _obsAll = !_obsAll; try{ openLegacy(); }catch(e){} };
