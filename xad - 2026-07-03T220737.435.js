...
window.openLegend = function(silent){
  ...
  var radarBlock = forming
    ? '<div class="legend-radar" style="position:relative"><div style="opacity:.24;filter:grayscale(.5)">'+radar+'</div><div style="position:absolute;top:0;left:0;right:0;bottom:0;display:flex;align-items:center;justify-content:center;color:#8a8576;font-size:11px;letter-spacing:4px;pointer-events:none">FORMING</div></div>'
