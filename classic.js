  ...
  function renderSearch(){
    ...
    if(lbl){
      if(CL.target==null){
        ...
        lbl.innerHTML='<span class="cl-lbl">ADDING <b>'+slot.pos+'</b>'+(slot.player?' <span class="cl-clear" onclick="clClear()">✕ remove '+clLast(slot.player.n)+'</span>':'')+'</span><span class="cl-cancel" onclick="window.clCancelPick&&clCancelPick()">← BACK</span>';
      }
    }
    clRenderList();
  }
