...
function flObservations(pr){
  ...
  try{
    ...
    if(nStories>=1)  out.push({id:"first_story", cat:"FIRST", w:200, text:"You discovered your first story.", proof:"The book has begun."});
    if(nStories>=10) out.push({id:"first_10", cat:"FIRST", w:210, text:"Ten stories in.", proof:"Your book is filling up."});
    if(totStories && nStories>=totStories) out.push({id:"first_all", cat:"FIRST", w:250, text:"Every story discovered.", proof:"All "+totStories+". Legendary."});
    ...
    if(distinct>=500)      out.push({id:"first_500leg", cat:"FIRST", w:195, text:"Five hundred legends have worn your shirt.", proof:distinct+" of "+dbTot+"."});
    else if(distinct>=250) out.push({id:"first_250leg", cat:"FIRST", w:192, text:"Two hundred and fifty legends have worn your shirt.", proof:distinct+" of "+dbTot+"."});
    else if(distinct>=100) out.push({id:"first_100leg", cat:"FIRST", w:190, text:"A hundred different legends have worn your shirt.", proof:distinct+" of "+dbTot+"."});
